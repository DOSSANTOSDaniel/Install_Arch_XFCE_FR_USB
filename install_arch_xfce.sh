...
#sed -i.bak 's/#FallbackNTP=0.arch.pool.ntp.org 1.arch.pool.ntp.org 2.arch.pool.ntp.org #3.arch.pool.ntp.org/FallbackNTP=0.fr.pool.ntp.org 1.fr.pool.ntp.org 2.fr.pool.ntp.org #3.fr.pool.ntp.org/' /etc/systemd/timesyncd.conf
...
pacstrap /mnt pacman-contrib grub networkmanager efibootmgr

# Apply partition table configs in fstab
genfstab -U /mnt >> /mnt/etc/fstab

# The default shell in installed system is BASH
# This current shell is ZSH

# Leave live system to new installed system

# Config time zone system
arch-chroot /mnt timedatectl set-timezone Europe/Paris

#sed -i 's/#NTP=/NTP=/' /mnt/etc/systemd/timesyncd.conf

#sed -i.bak 's/#FallbackNTP=0.arch.pool.ntp.org 1.arch.pool.ntp.org 2.arch.pool.ntp.org #3.arch.pool.ntp.org/FallbackNTP=0.fr.pool.ntp.org 1.fr.pool.ntp.org 2.fr.pool.ntp.org #3.fr.pool.ntp.org/' /mnt/etc/systemd/timesyncd.conf
...
#echo "LANG=fr_FR.UTF-8" >> /mnt/etc/environment
#echo "LANGUAGE=fr_FR.UTF-8" >> /mnt/etc/environment
...
# Graphycal install XFCE4
# Optimise mirrors
pacstrap /mnt reflector

cp /mnt/etc/pacman.d/mirrorlist /mnt/etc/pacman.d/mirrorlist.bak

arch-chroot /mnt reflector --verbose --country FR -l10 -p https --sort rate --save /etc/pacman.d/mirrorlist
